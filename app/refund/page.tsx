...
import { Shield, Clock, CreditCard, Mail, MessageCircle, FileText, CheckCircle2, AlertCircle } from 'lucide-react';
          ...
          <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <ol className="list-decimal pl-6 text-gray-700 space-y-2">
                      <li>Contact YourFlix support via <strong>WhatsApp</strong> or <strong>Email</strong> within 24 hours of purchase.</li>
            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-200 mb-10">
              ...
              <div className="p-6 md:p-8 space-y-8">
                ...
                <div>
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    YourFlix offers multiple subscription plans: 3 months, 6 months, and 12 months. 
                    Prices vary based on plan duration and number of devices selected. All prices are in EUR (Euro).
                  </p>
                  <ul className="list-disc pl-6 text-gray-700 mt-3 space-y-1">
                    <li>3 Months: €30 (1 device), €40 (2 devices), €55 (3 devices)</li>
                    <li>6 Months: €50 (1 device), €70 (2 devices), €99 (3 devices)</li>
                    <li>12 Months: €72 (1 device), €99 (2 devices), €139 (3 devices)</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 text-gray-700 mt-3 space-y-1">
                    <li>Smart TVs (Samsung, LG, Android TV, Google TV)</li>
                    <li>Amazon Fire Stick / Fire TV</li>
                    <li>Android TV boxes and Android phones/tablets</li>
                    <li>iOS devices (iPhone, iPad)</li>
                    <li>Windows and Mac computers (via compatible IPTV players)</li>
                  </ul>
                  <p className="text-gray-700 leading-relaxed mt-3">
                ...
                <div>
                  <h3 className="text-xl font-black text-black mb-3">13. Contact Information</h3>
                  <p className="text-gray-700 leading-relaxed">
                    For any questions regarding these Terms & Conditions, please contact us:
                  </p>
                  <ul className="list-disc pl-6 text-gray-700 mt-3 space-y-1">
                    <li>WhatsApp: <strong>+44 7549 589503</strong></li>
                    <li>Email: <strong>support@yourflix.vip</strong></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black text-white p-6 md:p-8 rounded-3xl text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl md:text-3xl font-black mb-3">Have Questions?</h3>
