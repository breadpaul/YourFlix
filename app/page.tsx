      ...
      <section className="py-24 bg-black text-center">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* 3 Months Plan */}
            <div className="bg-white rounded-xl overflow-hidden flex flex-col pt-8 relative border border-gray-200 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <div className="flex justify-center gap-1 mb-8">
                ...
                <span className="text-8xl font-black tracking-tighter text-black">{pricing[3][globalDeviceCount]}</span>
              </div>
              ...
              <div className="mt-auto border-t border-gray-100 p-5 bg-gray-50">
                <a href={`https://wa.me/447549589503?text=I%20want%20the%203%20Months%20YourFlix%20Plan%20for%20${globalDeviceCount}%20Device(s)%20paying%20%E2%82%AC${pricing[3][globalDeviceCount]}`} target="_blank" rel="noreferrer" className="w-full flex items-center justify-center gap-2 bg-[#FFC107] text-black font-bold text-sm py-3 rounded-lg hover:bg-[#E5AD06] transition-all uppercase tracking-wider">
            ...
            <div className="bg-white rounded-xl overflow-hidden flex flex-col pt-8 relative border-2 border-[#FFC107] shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
              ...
              <div className="flex justify-center gap-1 mb-8">
                <span className="text-2xl font-bold mt-2">€</span>
                <span className="text-8xl font-black tracking-tighter text-black">{pricing[6][globalDeviceCount]}</span>
              </div>
              <div className="h-px w-full bg-gray-100 mb-8" />
              <div className="flex-grow px-6 text-left text-sm text-gray-600 space-y-3 mb-8">
                {[
              ...
              <div className="mt-auto border-t border-gray-100 p-5 bg-gray-50">
                <a href={`https://wa.me/447549589503?text=I%20want%20the%206%20Months%20YourFlix%20Plan%20for%20${globalDeviceCount}%20Device(s)%20paying%20%E2%82%AC${pricing[6][globalDeviceCount]}`} target="_blank" rel="noreferrer" className="w-full flex items-center justify-center gap-2 bg-[#FFC107] text-black font-bold text-sm py-3 rounded-lg hover:bg-[#E5AD06] transition-all uppercase tracking-wider">
                  <MessageCircle className="w-4 h-4 shrink-0" />
                  Get YourFlix Now
                </a>
              </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden flex flex-col pt-8 relative border border-gray-200 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <div className="flex justify-center gap-1 mb-8">
                <span className="text-2xl font-bold mt-2">€</span>
                <span className="text-8xl font-black tracking-tighter text-black">{pricing[12][globalDeviceCount]}</span>
              </div>
              <div className="h-px w-full bg-gray-100 mb-8" />
              <div className="flex-grow px-6 text-left text-sm text-gray-600 space-y-3 mb-8">
                {[
              ...
              <div className="mt-auto border-t border-gray-100 p-5 bg-gray-50">
                <a href={`https://wa.me/447549589503?text=I%20want%20the%2012%20Months%20YourFlix%20Plan%20for%20${globalDeviceCount}%20Device(s)%20paying%20%E2%82%AC${pricing[12][globalDeviceCount]}`} target="_blank" rel="noreferrer" className="w-full flex items-center justify-center gap-2 bg-[#FFC107] text-black font-bold text-sm py-3 rounded-lg hover:bg-[#E5AD06] transition-all uppercase tracking-wider">
                  <MessageCircle className="w-4 h-4 shrink-0" />
                  Get YourFlix Now
                </a>
              </div>
